    ...
    <div className="container pt-10 flex justify-around items-center">
      <div className="grid xl:grid-cols-3 xl:grid-rows-2 gap-8">
         <div className="relative xl:col-span-2 xl:row-start-1 xl:row-end-[-1]">
            <img className="w-full h-full object-cover rounded-[20px]" src="./images/img1.webp" alt="hero img" />
         ...
         <div className="relative">
            <img className="w-full h-full object-cover rounded-[20px]" src="./images/img2.webp" alt="img2" />

            <div className="absolute max-w-[470px] sm:ml-16 ml-8 top-[50%] -translate-y-[50%] sm:space-y-4">
               <h2 className="text-2xl font-bold">Yummy pizza</h2>
               <p className="text-gray-500 text-xl pt-4">Starting At</p>
               <div className="font-medium text-red-500 text-2xl sm:text-2xl">
                  $25
               </div>
               <div className="bg-accentDark hover:bg-accent text-white p-2 flex rounded-full w-fit items-center gap-4 px-4 py-2 text-[14px] sm:p-6 sm:py-3 cursor-pointer">
                  Shop Now<FaArrowRight />   
         ...
         <div className="relative">
            <img className="w-full h-full object-cover rounded-[20px]" src="./images/img3.webp" alt="img3" />
